...
const SearchPage = ({ setAdsArr, setIsNoResult, resultsCount, setResultsCount, isMobileMode, setIsMobileMode }) => {
                ...
                <div className="simple-search__component">
                    ...
                    <div className="form-container">
                        <form className="simple-search">
                            ...
                            <SearchButton setAdsArr={setAdsArr} setIsNoResult={setIsNoResult} setResultsCount={setResultsCount} setIsAdvancedSearchOpen={setIsAdvancedSearchOpen} isMobileMode={isMobileMode} setIsMobileMode={setIsMobileMode} setIsMobileSearchOpen={setIsMobileSearchOpen} />
                        </form>
                    </div>
                </div>
